...
MOCK_METHOD(int, cap_clear_flag, (cap_t, cap_flag_t), ());
...
MOCK_METHOD(int, cap_get_flag, (cap_t, cap_value_t, cap_flag_t, cap_flag_value_t*), ());
MOCK_METHOD0(getuid, uid_t());
MOCK_METHOD(int, prctl, (int, unsigned long, unsigned long, unsigned long, unsigned long), ());
MOCK_METHOD(struct passwd*, getpwnam, (const char *), ());
MOCK_METHOD(int, setuid, (uid_t), ());
MOCK_METHOD(int, setgid, (gid_t), ());
